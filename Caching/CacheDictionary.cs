...
//    public class CacheDictionary2<TKey, TValue> : Dictionary<TKey, TValue>, ICache
//    {
//        #region Ctor
//        /// <summary>
...
//        /// <param name="getValueFunc">Function that returns the object (When the object is not in the cache, this method will be called)</param>
//        public CacheDictionary(int cacheTimeoutMinutes, Func<TKey, TValue> getValueFunc)
//        {
//            _cacheTimeoutMinutes = cacheTimeoutMinutes;
//            _cache = new MemoryCache(Guid.NewGuid().ToString());
//            _policy = new CacheItemPolicy { AbsoluteExpiration = DateTimeOffset.Now.AddMinutes(cacheTimeoutMinutes) };
