...
namespace Core.Extension
{
    public static class StringExtension
    {
        ...
        public static string ToLegalUrl(this string target)
        {
            ...
            {
                // LINQ Equivalent: target = IllegalUrlCharacters.Aggregate(target, (current, character) => current.Replace(character.ToString(Constants.CurrentCulture), string.Empty));
