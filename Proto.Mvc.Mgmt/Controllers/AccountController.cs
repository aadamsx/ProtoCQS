...
namespace Proto.Mvc.Mgmt.Controllers
{
    ...
    {
        // Removed based on Simple Injector implementation and the following exception:
        // SimpleInjector.ActivationException: For the container to be able to create AccountController, 
